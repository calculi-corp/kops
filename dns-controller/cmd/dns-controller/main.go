...
import (
	...
	_ "k8s.io/kops/dnsprovider/pkg/dnsprovider/providers/azure/armdns"
...
func main() {
	...
	flags.StringVar(&dnsProviderID, "dns", "aws-route53", "DNS provider we should use (aws-route53, google-clouddns, digitalocean, azure-dns, gossip)")
